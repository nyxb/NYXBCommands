...
export class Cooldowns {
  constructor(instance: NYXB, cooldownConfig: CooldownConfig) {}
}
...
export class Command {
  constructor(instance: NYXB, commandName: string, commandObject: CommandObject)

  public get instance(): NYXB
