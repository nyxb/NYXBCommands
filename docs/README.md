...
The documentation site publishes to https://nyxbcommands.nyxb.nexus.
...
1. [Fork the NYXBCommands GitHub project](https://github.com/nyxb/NYXBCommands/fork) into your own account
...
6. Run `pnpm run dev` to launch a preview
7. Visit `localhost:3000/` to see a live preview of the docs

### Contributing

When you are ready to submit work back to the main NYXBCommands repo, create a PR.
...
6. Go to your fork of the NYXBCommands project in your GitHub account
7. Select the **Pull Request** tab
8. Select **New Pull Request**
9.  Confirm the repo/branches to compare
   - Base repo should be **nyxb/NYXBCommands**
...
Avoid screenshots until NYXBCommands reaches a stable release.
